...
import {Card, CardActions, CardHeader, CardMedia, CardTitle, CardText} from 'material-ui/Card/index';
import Checkbox from 'material-ui/Checkbox/index';
import Badge from 'material-ui/Badge/index';
...
export default class Tweet extends React.Component{
	...
	reTweet(ev:any, val:any){
		TweetAction.reTweet(this.props.tweet);
	}

	likeTweet(ev:any, liked:any){
		...
		<Card class="tweet-card">
			...
			<CardActions >
				<Badge badgeContent={reTweetCt} primary={true} badgeStyle={{top: 24, right: 24}}>
					<IconButton tooltip="ReTweet" onClick={this.reTweet.bind(this)}><ActionRestore/></IconButton>
				</Badge>
